...
int main(int argc, char** argv) {
    ...
    //    counter++;
    //}
    vector<int> track0 = {53, 785};
    vector<int> track1 = {914, 350};
    vector<int> track2 = {827, 567};
    vector<int> track3 = {302, 230};
    vector<int> track4 = {631, 11};
    diskInput.insert(make_pair(0, track0));
    diskInput.insert(make_pair(1, track1));
    diskInput.insert(make_pair(2, track2));
    diskInput.insert(make_pair(3, track3));
    diskInput.insert(make_pair(4, track4));
